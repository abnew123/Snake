...
public class TimeSnake extends Snake {

	private ImageView image = new ImageView();
	private List<Point> bodyParts;
	private int direction;
	public static final int DEFAULT_SIZE = 50;
	public static final int TIME_TO_UPGRADE = 5;
	private int timeRemaining = TIME_TO_UPGRADE;
	public TimeSnake(int size) {
